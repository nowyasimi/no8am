...
Section.prototype.restructureHours = function(hours) {
    var timesMet = [];
    while (hours != '') {
...
Section.prototype.parseTimesMet = function() {
...
Section.prototype.genElement = function(classID, hidden, sectionNum, color) { // if selected, no 'N' in front
    var elements = [];
...
Section.prototype.listGen = function(classID, selected, sectionNum) {
    return {
        isSelected: selected,
        classId: classID,
